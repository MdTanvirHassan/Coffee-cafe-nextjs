      ...
      <div className="grid md:grid-cols-3 gap-8 m-auto">
        <div className="grid grid-rows-3 gap-0">
          <div className="row-span-1">
            <p className="lg:w-[424px] lg:h-[194px]">
          ...
          <div className="row-span-2 w-[424px] h-[487px]">
            <Image src={cup} alt=".." className="w-full" />
          </div>
        </div>

        <div className="grid grid-rows-3 gap-0">
          <div className="row-span-2 w-[536px] h-[522px]">
            <Image src={cup2} alt=".." className="w-full h-full" />
          </div>
          <div className="row-span-1">
            <p className="lg:w-[530px] lg:h-[159px]">
        ...
        <div className="grid grid-rows-3 gap-0 my-auto -right-28 relative">
          <div className="row-span-2 w-[312px] h-[281px]">
            <Image src={cup3} alt=".." className="w-full h-full" />
          </div>
          <div className="row-span-1">
            <p className="lg:w-[283px] lg:h-[54px]">
